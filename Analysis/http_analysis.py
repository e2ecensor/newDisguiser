...
url_list = ["3.110.30.127", "18.133.196.172", "54.197.194.180", "18.228.203.42", "50.18.245.54", "157.175.188.96", "13.244.77.102"]
correct_http_page = 'http\n'


with open('/Volumes/Macintosh/Users/crystal/disguiser/code/2022-08-06_http_proxyrack_censorship_attempt4.json', 'r') as f:
    line = f.readline()
    country_count = {}
    suspicious_vps = {}
